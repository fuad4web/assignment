      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <?php 
                  $no_admins  = $getFromU->count_two_cond('user', 'status', 'status', 'admin', 'approve', 1);
                ?>
                <h3><?= $no_admins; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
              <?php 
                $no_lect = $getFromU->count_two_cond('user', 'status', 'status', 'lecturer', 'approve', 1);
              ?>
                <h3><?= $no_lect; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>
                  <?php 
                    @$overall_scores = $getFromU->sum_all_column('answers', scores);
                    $stu_no = $getFromU->count_all_col('answers', 'id');
                    $ave = $stu_no * 20;
