          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>
                  <?php 
                    @$overall_scores = $getFromU->sum_column_one_cond('answers', scores, 'user_id', $user_id);
                    $stu_no = $getFromU->count_one_cond('answers', 'id', 'user_id', $user_id);
                    $ave = $stu_no * 20;
                    $percentage = ($overall_scores / $ave) * 100;
                    echo substr($percentage, 0, 5);
                  ?>
